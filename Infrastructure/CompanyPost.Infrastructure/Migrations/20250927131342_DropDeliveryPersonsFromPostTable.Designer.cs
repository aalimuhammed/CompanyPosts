...
namespace CompanyPost.Infrastructure.Migrations
{
    ...
    [Migration("20250927131342_DropDeliveryPersonsFromPostTable")]
    partial class DropDeliveryPersonsFromPostTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CompanyPost.Domain.Entities.Posts", b =>
                {
                    ...
                    b.HasIndex("PersonOrgId")
                        .HasDatabaseName("ix_posts_person_org_id");
            ...
            modelBuilder.Entity("CompanyPost.Domain.Entities.Posts", b =>
                {
                    ...
                    b.HasOne("CompanyPost.Domain.Entities.PersonOrg", null)
                        .WithMany("PostsAsDeliveryPerson")
                        .HasForeignKey("PersonOrgId")
                        .HasConstraintName("fk_posts_person_orgs_person_org_id");
